        ...
        <el-container style="height: 100%;">
            <el-aside width="240px">
                <el-menu class="menu">
                    ...
                    <el-menu-item index="2" @click="$router.push('/test/testPublic')" class="hover-container">
                    ...
                    <el-menu-item index="8" @click="$router.push('/test/testTeam')" class="hover-container">
...
import PublicTree from "@/test/testPublicTree.vue";
import TeamTree from "@/test/testTeamTree.vue";
